...
@export var popup_scene: PackedScene = preload("res://Scenes/ui/Next_Stage_3.tscn")
...
func buka_pintu():
	...
	var celebration = preload("res://Scenes/ui/NextStageCelebration3.tscn").instantiate()
